...
int read_print(int file, char *fstring)
{
    ...
    fpLowTemp = fopen("LowTemp","r+");
    fpHighTemp = fopen("HighTemp","r+");
    ...
    fprintf(fp1," %.2f hPa %.2f deg C %d\n", pressure, fTemp, epoch_time);
    if (fTemp < fLowTemp)
    {
        printf("New low temp %2.2f\n", fTemp);
                fpLowTemp = fopen("LowTemp","w+");
